...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //Crear el ViewModel A partir del factory
    ...
    private fun setObservers(viewModel: SleepTrackerViewModel) {

        //Obserber para evento de navegación
        ...
        //Observer para visualizar snackbar
